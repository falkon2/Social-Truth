      ...
      <div class="space-x-4 flex items-center">
        {#if user}
          ...
          <div class="relative" use:clickOutside on:clickoutside={closeDropdown}>
            ...
            {#if dropdownOpen}
              <div class="absolute right-0 mt-2 w-48 bg-[#2a2a2a] rounded-md shadow-lg py-1">
                <a 
                  href="/profile" 
                  class="block px-4 py-2 text-sm text-[#f0f0f0] hover:bg-[#3a3a3a]"
                ...
                <button 
                  ...
                  class="block w-full text-left px-4 py-2 text-sm text-[#f0f0f0] hover:bg-[#3a3a3a]"
                >
                  Logout
                </button>
              </div>
